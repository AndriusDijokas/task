...
import com.workforpica.task.exception.OAuth2AuthenticationProcessingException;
import com.workforpica.task.repository.UserRepository;
import com.workforpica.task.security.UserPrincipal;
import com.workforpica.task.security.oauth2.user.OAuth2UserInfo;
import com.workforpica.task.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) throws OAuth2AuthenticationProcessingException {
        ...
        if(oAuth2UserInfo.getEmail().isEmpty() || oAuth2UserInfo.getEmail().isBlank()) {
